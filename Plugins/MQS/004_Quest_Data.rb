module QuestModule
  ...
  :ID => "13",
  :Name => "Pokémon-Jagd",
  :QuestGiver => "Pokémon Trainer",
  :Stage1 => "Fange ein Bidiza und ein Hoothoot.",
  :Location1 => "Selago Meadows",
  :QuestDescription => "Fange ein Bidiza und ein Hoothoot.",
  :RewardString => "Seltenes Pokémon Ei"
}
...
Quest14 = {
  ...
  :Stage1 => "Fange ein Bidiza und ein Hoothoot.",
  :Location1 => "Selago Meadows",
  :QuestDescription => "Someone at the Tomb of the Spirits is waiting for you.",
  :RewardString => "Seltenes Pokémon Ei"
}
