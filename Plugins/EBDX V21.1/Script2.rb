  #=============================================================================
   #HORIZONTAL ATTACK BUTTONS
   #CREATED BY MARYN @cosmic_pipo/@PkmnRadiante(on TW/X)
   #V21.1(BASE BY SKY)
  #=============================================================================
  class Battle::Scene::FightMenu < Battle::Scene::MenuBase
    GET_MOVE_TEXT_COLOR_FROM_MOVE_BUTTON = true #Change to false if you want buttons to not show colors based on type
  #==========================================================================================================================================================
    PP_COLORS = [                                      # PP colors
    Color.new(248, 72, 72), Color.new(136, 48, 48),    # Red, when PP is 0
    Color.new(248, 136, 32), Color.new(144, 72, 24),   # Orange when 1/4 of PP or less remains
    Color.new(248, 192, 0), Color.new(144, 104, 0),    # Yellow, when 1/2 of PP or less remains
    Color.new(255, 255, 255), Color.new(32, 32, 32)    # Normal color when greater than 1/2
  ]
  end
  #==========================================================================================================================================================
  class Battle::Scene::MenuBase
    BUTTON_HEIGHT = 46
    TEXT_BASE_COLOR   = Color.new(255, 255, 255) #Only works when GET_MOVE_TEXT_COLOR_FROM_MOVE_BUTTON is false, this is the base color
    TEXT_SHADOW_COLOR = Color.new(32, 32, 32) #Only works when GET_MOVE_TEXT_COLOR_FROM_MOVE_BUTTON is false, this is the shadow color
  end
  #==========================================================================================================================================================
class Battle::Scene::FightMenu < Battle::Scene::MenuBase
...
@buttons = Array.new(Pokemon::MAX_MOVES) do |i|  
  ...
  button.src_rect.height = @buttonBitmap.height / 19
